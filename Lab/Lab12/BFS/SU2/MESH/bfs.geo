...
H 	= 0.040;	// Heigth of the step
h 	= 0.0267;	// Hiegth of the channel
L	= 35*h;		// Length of the channel past the step
l	= 20*h;		// Length of the channel before the step
...
Transfinite Line{8} = nPc 	Using Progression 	pc;
Transfinite Line{6} = nPc 	Using Progression 	1/pc;
